...
require (
	...
	github.com/giantswarm/companyd-client-go v0.6.1 // indirect
	github.com/giantswarm/config-controller v0.10.0 // indirect
	github.com/giantswarm/credentiald/v2 v2.17.0 // indirect
	...
	sigs.k8s.io/cluster-api-provider-aws/v2 v2.3.1 // indirect
