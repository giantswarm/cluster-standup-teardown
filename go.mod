module github.com/giantswarm/cluster-standup-teardown/v2
...
require (
	...
	github.com/giantswarm/clustertest/v2 v2.0.0
...
require (
	...
	github.com/fluxcd/helm-controller/api v1.4.1 // indirect
