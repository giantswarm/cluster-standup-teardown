...
- Bump `clustertest` from v3 to v4.0.0 (CAPI v1beta1 to v1beta2 migration).
...
- CAPV/CAPVCD: remove references to container registry secret.
...
- Use aliyun container registry configuration for China clusters.
...
- Don't rely on workers having labels. Instead, filter by nodes not having the control plane label.
...
- Add new cluster builder for karpenter clusters.
...
- Bring back lower heartbeat timeout to allow NTH to terminate instances more quickly.
...
[Unreleased]: https://github.com/giantswarm/cluster-standup-teardown/compare/v5.2.0...HEAD
...
[2.3.0]: https://github.com/giantswarm/cluster-standup-teardown/compare/v2.2.2...v2.3.0
...
[2.0.1]: https://github.com/giantswarm/cluster-standup-teardown/compare/v2.0.0...v2.0.1
[2.0.0]: https://github.com/giantswarm/cluster-standup-teardown/compare/v1.36.0...v2.0.0
[1.36.0]: https://github.com/giantswarm/cluster-standup-teardown/compare/v1.35.3...v1.36.0
[1.35.3]: https://github.com/giantswarm/cluster-standup-teardown/compare/v1.35.2...v1.35.3
...
[1.30.0]: https://github.com/giantswarm/cluster-standup-teardown/compare/v1.29.0...v1.30.0
